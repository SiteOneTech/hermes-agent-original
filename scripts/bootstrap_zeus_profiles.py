...
PROFILE_SPECS: dict[str, ProfileSpec] = {
    ...
    "implementation-planner": ProfileSpec(
        ...
        non_mission="No resolver implementación final si falta arquitectura o PRD; no inflar planes con tareas no accionables.",
        workflow="Lee PRD/ADR, genera plan por commits pequeños, define tests RED/GREEN y dependencias entre tareas.",
    ...
    "qa-verifier": ProfileSpec(
        ...
        assigned_skills=[COMMON_FACTORY_SKILL, "dogfood", "systematic-debugging", "test-driven-development"],
        ...
        workflow="Construye, ejecuta tests, valida rutas críticas, captura evidencia y registra blockers.",
    ...
    "devops-release": ProfileSpec(
        ...
        assigned_skills=[COMMON_FACTORY_SKILL, "github-pr-workflow", "repo-origin-sync", "systematic-debugging", "agent-vm-operations"],
        ...
        workflow="Inspecciona service/unit/env, aplica cambios, reinicia supervisor, valida puerto/health/CI.",
    ...
    "factory-reporter": ProfileSpec(
        ...
        workflow="Lee DB/docs/runs, resume por proyecto/incremento, marca pendientes y sincroniza proyección humana cuando aplique.",
        boundaries="La fuente de verdad es Agent Core + repo docs/git; Notion es proyección.",
