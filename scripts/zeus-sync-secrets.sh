...
# Accounting and Agent Management run in the same Agent Core DB. While older
# Infisical projects are missing dedicated module secrets, inherit the
...
# value overrides each fallback automatically.
set_if_missing('ACCOUNTING_DB_RUNTIME_USER', values.get('ACCOUNTING_DB_RUNTIME_USER') or 'accounting_runtime')
set_if_missing('ACCOUNTING_DB_RUNTIME_PASSWORD', values.get('AGENT_DB_RUNTIME_PASSWORD'))
...
set_if_missing('ALPHA_RESEARCH_DB_RUNTIME_USER', values.get('ALPHA_RESEARCH_DB_RUNTIME_USER') or 'alpha_research_runtime')
set_if_missing('ALPHA_RESEARCH_DB_REVIEWER_USER', values.get('ALPHA_RESEARCH_DB_REVIEWER_USER') or 'alpha_research_reviewer')
...
host_url('SALES_OPERATOR_DB_RUNTIME_USER', 'SALES_OPERATOR_DB_RUNTIME_PASSWORD', 'AGENT_DB_NAME', 'SALES_OPERATOR_DATABASE_URL')
...
host_url('ALPHA_RESEARCH_DB_RUNTIME_USER', 'ALPHA_RESEARCH_DB_RUNTIME_PASSWORD', 'AGENT_DB_NAME', 'ALPHA_RESEARCH_DATABASE_URL')
host_url('ALPHA_RESEARCH_DB_REVIEWER_USER', 'ALPHA_RESEARCH_DB_REVIEWER_PASSWORD', 'AGENT_DB_NAME', 'ALPHA_RESEARCH_REVIEWER_DATABASE_URL')
...
docker_url('SALES_OPERATOR_DB_RUNTIME_USER', 'SALES_OPERATOR_DB_RUNTIME_PASSWORD', 'AGENT_DB_NAME', 'SALES_OPERATOR_DATABASE_URL_DOCKER')
...
docker_url('ALPHA_RESEARCH_DB_RUNTIME_USER', 'ALPHA_RESEARCH_DB_RUNTIME_PASSWORD', 'AGENT_DB_NAME', 'ALPHA_RESEARCH_DATABASE_URL_DOCKER')
docker_url('ALPHA_RESEARCH_DB_REVIEWER_USER', 'ALPHA_RESEARCH_DB_REVIEWER_PASSWORD', 'AGENT_DB_NAME', 'ALPHA_RESEARCH_REVIEWER_DATABASE_URL_DOCKER')
