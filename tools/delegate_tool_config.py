...
def _resolve_child_runtime(
    ...
    if override_api_mode is not None:
        ...
        # Same principle for base_url: an inherited endpoint sends the child's requests to the parent's
        # provider (delegate_task -> deepseek 404). Clear it so AIAgent.__init__ resolves the correct
        # base_url from the child's own provider configuration.
