...
def create_job(
    ...
    profile: Hermes profile name to run under, so that profile's HERMES_HOME (config,
    credentials, scripts, skills, memory) resolves at fire time; "default" is the root profile,
    empty/None keeps the scheduler's own profile."""
