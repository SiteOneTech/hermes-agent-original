...
/** Whether native OS paths and the active gateway share this machine. */
...
export const host = {
  state: {
    ...
    /** Resolved gateway location. Native picker paths are backend-readable
     *  only in local mode. */
    connectionMode: readonlyAtom<null | 'local' | 'remote'>($activeConnectionMode),
