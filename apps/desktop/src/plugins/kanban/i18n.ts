...
type KanbanMessages = {
  ...
  remoteTransferUnavailable: string
...
export const en: KanbanMessages = {
  ...
  remoteTransferUnavailable: 'Board import and export are unavailable while connected to a remote gateway.',
...
const ja: KanbanMessages = {
  ...
  remoteTransferUnavailable: 'リモートゲートウェイへの接続中は、ボードのインポートとエクスポートを利用できません。',
...
const zh: KanbanMessages = {
  ...
  remoteTransferUnavailable: '连接到远程网关时无法导入或导出面板。',
...
const zhHant: KanbanMessages = {
  ...
  remoteTransferUnavailable: '連線至遠端閘道時無法匯入或匯出面板。',
