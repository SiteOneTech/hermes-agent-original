...
def test_claim_next_task_allows_metadata_documentation_recovery_past_validation_readiness(fake_sql, monkeypatch):
    ...
    documentation_recovery = {
        "project_id": "demo",
        "lane_id": "lane-g1",
        "task_id": "demo-r2df-r44-explicit-g1-validation",
        "status": "todo",
        "phase": "documentation",
        "priority": 19,
        "title": "R2df-R44 — explicit G1 validation preflight",
        "description": (
...
def test_g1_recovery_metadata_keeps_validation_and_reporting_work_fail_closed():
    report = {
        "task_id": "demo-r2df-r44-final-report",
        "phase": "g1_recovery",
    ...
    security = {
        "task_id": "demo-r2df-r44-security",
        "phase": "security_review",
