...
class TestListProfiles:
    ...
    def test_name_listing_keeps_tombstones_for_router_cleanup(self, profile_env):
        """A tombstoned directory stays discoverable until the router consumes it."""
        ...
        assert "retiring" in profiles.list_profile_names()
