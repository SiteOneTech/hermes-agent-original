...
class TestDelegationCleanup:
    ...
    def test_timed_out_child_keeps_relay_session_until_its_turn_exits(
        ...
        # Allow an executor worker to be scheduled even when the per-file
        # isolation runner is saturated; the assertion below still requires a
        # genuinely timed-out child whose relay turn remains active.
