...
| `PRD.md` | updated for I9; planning review pending; owner: implementation-planner; reviewer: solution-architect | Defines Revenue Operator v2 private Kidu cockpit, safe snapshots, freshness, real/synthetic labels, outcomes, and no-send boundary. |
| `ADRS.md` | updated for I9; planning review pending; owner: implementation-planner; reviewer: solution-architect | Records ADR-I9: read-only private cockpit over sanitized snapshots; no browser sends/providers. |
...
| `TECHNICAL_BLUEPRINT.md` | updated for I9; planning review pending; owner: implementation-planner; reviewer: solution-architect | Defines snapshot exporter/schema, cockpit UI, policy panel, Kidu sandbox boundary, and verification strategy. |
| `SPRINT_PLAN.md` | updated for I9; planning review pending; owner: implementation-planner; reviewer: solution-architect | Defines phases through implementation, quality_review, security_review, deploy, QA browser/post-deploy, delivery report. |
| `TASK_GRAPH.md` | updated for I9; planning review pending; owner: implementation-planner; reviewer: solution-architect | Contains mandatory UI task graph and owner/input/output/verification rows. |
| `TRACKER.md` | updated for I9; planning review pending; owner: implementation-planner; reviewer: solution-architect | Tracks I9 planning, downstream reviews/deploy/QA/report, and active no-send boundary. |
| `DOCUMENTATION_INDEX.md` | updated for I9; planning review pending; owner: implementation-planner; reviewer: solution-architect | This index maps the updated control pack and I9 boundary. |
| `QA_GATES.md` | updated for I9; planning review pending; owner: implementation-planner; reviewer: qa-verifier | Adds QA failures/checklists for freshness, synthetic-vs-real, safe snapshots, no credentials, and no browser sends. |
| `SECURITY_GATES.md` | updated for I9; planning review pending; owner: implementation-planner; reviewer: security-reviewer | Adds hard blockers for secrets, provider/auto-send/cold WhatsApp, browser side effects, and synthetic-as-real outcomes. |
