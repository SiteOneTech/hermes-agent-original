...
| `last_verified_origin_main` | R2n read-only verification fetched canonical `origin/main` and recorded exact current base `df4c77fd1413a65cdb85885a06978ff157c1de4d`; the assigned R2n branch/worktree was initially equal to that SHA before this canonical-document repair. R2m previously recorded `ab08b13669903a87b3d60d6c80231d23d6313782`, and R2k previously observed remote `origin/main` as `83d5ee06ba25859f047469baed223fe88e9467e3`; those are now historical base evidence, not the active review base. Earlier `e3d04ff94b67e6e21be1d5515bdb71400fbedf0a` and `00e7bb4ab0fcd9013ffa924ce6c5a8ae2c2ae2fc` evidence is historical only. |
| `r2m_current_base_candidate` | Historical handoff branch `factory/zeus-alpha-research-ledger-core/inc-001-r2m-current-base-g1-documentatio` in worktree `/home/jean/Projects/.worktrees/zeus-alpha-research-ledger-core/inc-001-r2m-current-base-g1-documentatio`; base `origin/main` `ab08b13669903a87b3d60d6c80231d23d6313782`; superseded by R2n for active review because the canonical base advanced. |
| `r2n_current_base_candidate` | Branch `factory/zeus-alpha-research-ledger-core/inc-034-r2n-repair-g1-canonical-document` in worktree `/home/jean/Projects/.worktrees/zeus-alpha-research-ledger-core/inc-034-r2n-repair-g1-canonical-document`; base `origin/main` `df4c77fd1413a65cdb85885a06978ff157c1de4d`; documentation-only canonical-document status repair and exact-SHA review handoff; no merge/deploy/external runtime authority. |
...
R2k records a second provenance drift: project metadata still points to PR #20 / `dad375f27568c38be771fc597b579d087f034e1d` while R2j has already been delivered as PR #30 / `c1943efb2b97b54b42bc5eabe858340d8c391116`. R2m recorded a successor handoff after PR #31/R2k reached `origin/main`, but R2n supersedes it on the current base `df4c77fd1413a65cdb85885a06978ff157c1de4d`. Stale PR #20, historical PR #29, PR #30, PR #31 and R2m exposure are not active dispatch evidence. ALR-020+ remains blocked until a renewed exact-SHA independent review of the current R2n PR head is recorded and canonical Factory `document_status` is reconciled.
