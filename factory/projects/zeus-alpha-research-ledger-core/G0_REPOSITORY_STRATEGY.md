...
| `last_verified_origin_main` | R2k read-only verification observed remote `origin/main` as `83d5ee06ba25859f047469baed223fe88e9467e3`, the PR #30 merge commit for R2j head `c1943efb2b97b54b42bc5eabe858340d8c391116`; local primary `main` still reads `4eb87e4cd48105af05fe974cf1d493f0e1b57ae1` and does not contain `c1943efb2b97b54b42bc5eabe858340d8c391116`. Earlier `e3d04ff94b67e6e21be1d5515bdb71400fbedf0a` and `00e7bb4ab0fcd9013ffa924ce6c5a8ae2c2ae2fc` evidence is historical only. |
...
R2k records a second provenance drift: project metadata still points to PR #20 / `dad375f27568c38be771fc597b579d087f034e1d` while R2j has already been delivered as PR #30 / `c1943efb2b97b54b42bc5eabe858340d8c391116`. That metadata is not current dispatch evidence. ALR-020+ remains blocked until a renewed exact-SHA review of the R2k PR is recorded and canonical Factory `document_status` is reconciled.
