...
| `last_verified_origin_main` | R2at read-only verification records canonical `origin/main` and assigned worktree `HEAD=origin/main=merge-base=a41acdc4820b92a31b7d42d9a9c28e95b875a3d1` before this documentation/provenance repair. R2ap `3e32da02c218e06a69b851641b2d454113654378`, R2aj `bf422968f9ea73d70d4ac1e8b8bae4af644ce079`, R2c2 `dbde1790f8d45f111bc69b3491a1862eafb29fa2`, R2ah `1b6bc0f65d3ad49845d20e056203e3b3702ac2a7`, R2m `ab08b13669903a87b3d60d6c80231d23d6313782`, R2k `83d5ee06ba25859f047469baed223fe88e9467e3`, and earlier `e3d04ff94b67e6e21be1d5515bdb71400fbedf0a` / `00e7bb4ab0fcd9013ffa924ce6c5a8ae2c2ae2fc` evidence are historical only. |
...
| `r2c2_current_base_candidate` | Branch `factory/zeus-alpha-research-ledger-core/inc-018-r2c2-autonomous-canonical-g1-doc` in worktree `/home/jean/Projects/.worktrees/zeus-alpha-research-ledger-core/inc-018-r2c2-autonomous-canonical-g1-doc`; base `origin/main` `dbde1790f8d45f111bc69b3491a1862eafb29fa2`; documentation-only autonomous canonical G1 `document_status` evidence repair and PR-first exact-SHA review handoff; no merge/deploy/external runtime authority. |
| `r2aj_current_base_candidate` | Branch `factory/zeus-alpha-research-ledger-core/inc-017-r2aj-isolated-current-base-g1-do` in worktree `/home/jean/Projects/.worktrees/zeus-alpha-research-ledger-core/inc-017-r2aj-isolated-current-base-g1-do`; base `origin/main` `bf422968f9ea73d70d4ac1e8b8bae4af644ce079`; documentation-only isolated current-base G1 evidence recovery and PR-first exact-SHA review handoff; no merge/deploy/primary-checkout mutation/direct-SQL/external runtime authority. |
| `r2ap_current_origin_candidate` | Branch `factory/zeus-alpha-research-ledger-core/inc-019-r2ap-current-origin-g1-document` in worktree `/home/jean/Projects/.worktrees/zeus-alpha-research-ledger-core/inc-019-r2ap-current-origin-g1-document`; base `origin/main` `3e32da02c218e06a69b851641b2d454113654378`; documentation-only current-origin G1 validation/provenance recovery and PR-first exact-SHA review handoff; no merge/deploy/primary-checkout mutation/direct-SQL/external runtime authority. |
| `r2at_current_origin_candidate` | Branch `factory/zeus-alpha-research-ledger-core/inc-001-r2at-current-origin-g1-documenta` in worktree `/home/jean/Projects/.worktrees/zeus-alpha-research-ledger-core/inc-001-r2at-current-origin-g1-documenta`; base `origin/main` `a41acdc4820b92a31b7d42d9a9c28e95b875a3d1`; documentation-only current-origin G1 documentation validation technical rework and PR-first exact-SHA quality-review handoff; no merge/deploy/primary-checkout mutation/direct-SQL/no-auto-merge/no external runtime execution authority. |
...
R2k records a second provenance drift: project metadata still points to PR #20 / `dad375f27568c38be771fc597b579d087f034e1d` while R2j has already been delivered as PR #30 / `c1943efb2b97b54b42bc5eabe858340d8c391116`. R2m records the current-base successor handoff after PR #31/R2k reached `origin/main`: stale PR #20, historical PR #29, PR #30 and PR #31 exposure are not active dispatch evidence. R2ah records the current-origin `1b6bc0f65d3ad49845d20e056203e3b3702ac2a7` reviewed-marker/index repair and PR #47 handoff. R2c2 renews the current-base document-status evidence at `origin/main` `dbde1790f8d45f111bc69b3491a1862eafb29fa2`; R2aj renews it again at `origin/main` `bf422968f9ea73d70d4ac1e8b8bae4af644ce079` and rejects stale PR #44 as current-base evidence. Both require a Zeus-signed `agent:zeus` PR plus independent exact-SHA review. ALR-020+ remains blocked until canonical Factory `document_status` and task gates are reconciled by the authorized control path.
