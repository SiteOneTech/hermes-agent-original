...
| `last_verified_origin_main` | R2m read-only verification fetched canonical `origin/main` and recorded exact current base `ab08b13669903a87b3d60d6c80231d23d6313782`; the assigned R2m branch/worktree was initially equal to that SHA before the current-base handoff docs were added. R2k previously observed remote `origin/main` as `83d5ee06ba25859f047469baed223fe88e9467e3`, the PR #30 merge commit for R2j head `c1943efb2b97b54b42bc5eabe858340d8c391116`; that is now historical base evidence, not the active review base. Earlier `e3d04ff94b67e6e21be1d5515bdb71400fbedf0a` and `00e7bb4ab0fcd9013ffa924ce6c5a8ae2c2ae2fc` evidence is historical only. |
| `r2y_current_base_alignment` | R2y read-only verification fetched `origin/main` and recorded exact current base/source `1b6bc0f65d3ad49845d20e056203e3b3702ac2a7` in the assigned worktree `factory/zeus-alpha-research-ledger-core/inc-001-r2y-repair-canonical-g1-document`; Factory status read-back from the repository venv reports zero required G1 document blockers from `readiness_source=configured_base_ref` at that same SHA. |
...
R2k records a second provenance drift: project metadata still points to PR #20 / `dad375f27568c38be771fc597b579d087f034e1d` while R2j has already been delivered as PR #30 / `c1943efb2b97b54b42bc5eabe858340d8c391116`. R2m records the current-base successor handoff after PR #31/R2k reached `origin/main`: stale PR #20, historical PR #29, PR #30 and PR #31 exposure are not active dispatch evidence. ALR-020+ remains blocked until a renewed exact-SHA independent review of the current R2m PR head is recorded and canonical Factory `document_status` is reconciled.
