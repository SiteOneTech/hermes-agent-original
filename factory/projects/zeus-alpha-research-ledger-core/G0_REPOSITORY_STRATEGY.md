...
R2k records a second provenance drift: project metadata still points to PR #20 / `dad375f27568c38be771fc597b579d087f034e1d` while R2j has already been delivered as PR #30 / `c1943efb2b97b54b42bc5eabe858340d8c391116`. R2m records the earlier current-base successor handoff after PR #31/R2k reached `origin/main`. R2q supersedes the active docs-candidate handoff by restoring the PR #34/gate-790 reviewed-docs markers on current base `df4c77fd1413a65cdb85885a06978ff157c1de4d` and rejecting the invalid R2p HTTP-429 review as completion evidence. Stale PR #20, historical PR #29, PR #30, PR #31, R2m exposure, PR #35/R2p code-path evidence and provider-failed review runs are not active dispatch evidence. ALR-020+ remains blocked until a valid independent exact-SHA solution-architect review of the final R2q PR head is recorded and canonical Factory `document_status` or authorized reviewed-candidate metadata is reconciled.
