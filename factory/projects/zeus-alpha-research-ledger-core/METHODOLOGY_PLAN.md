...
1. **ALR-010** remediates this documentary pack, completes a second independent pass, commits it and proposes a documentation PR.
...
## Stop conditions
Stop and create a concrete repair task if G1 docs are stale; the role/secret/grant matrix is incomplete; source terms/freshness are unknown; a test does not first fail; a tool/script implies external action; a migration risks unrelated schemas; no-egress proof fails; or scope drifts into Vonash/trading/paper/live behavior.
