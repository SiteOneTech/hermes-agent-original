...
- `R2S_REVIEWED_G1_CANDIDATE_RESOLUTION.md` records the control-plane repair that lets canonical `factory status` resolve reviewed G1 candidate PR #36 from Factory task/gate evidence while preserving primary/main truth and fail-closed stale/unreviewed/merged rejection.
...
4. `QA_GATES.md`, `SECURITY_GATES.md`, `G1_REVIEW.md`, `R2K_STALE_CANONICAL_G1_PROVENANCE_REPAIR.md`, `R2M_CURRENT_BASE_G1_REVIEW_HANDOFF.md`, `R2S_REVIEWED_G1_CANDIDATE_RESOLUTION.md`
