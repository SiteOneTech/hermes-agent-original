...
|---|---|---|---|
| ALR-010-R2/R2e | G1 rebaseline + G0 + traceability + gate-695/gate-697 direct-integration reconciliation and PR-first current-base candidate visibility | — | committed corrected docs on assigned branch, Zeus-signed `agent:zeus` PR, independent exact-SHA spec/security/quality PASS reviews; no downstream implementation before those reviews |
| ALR-020 | schema, constraints, dedicated role/grants | ALR-010-R2/R2e exact-SHA reviews accepted; Zeus PR/review/base-visibility evidence recorded; ALR-020 acceptance metadata corrected/read back | RED/GREEN migration and direct-role tests |
