...
- R2n renewal evidence must be candidate-bound to the exact R2n PR head SHA on base `origin/main` `df4c77fd1413a65cdb85885a06978ff157c1de4d`. Obsolete project metadata pointing to PR #20 / `dad375f27568c38be771fc597b579d087f034e1d`, historical PR #29/f61a review PASS records, PR #30/c1943 merge evidence, PR #31/R2k exposure and the R2m handoff are not sufficient to change G1 docs to `reviewed: yes` or dispatch ALR-020 until canonical Factory metadata and `document_status` read back reconciled.
