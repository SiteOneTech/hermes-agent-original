...
| PR-first/QA Guardian + merge reconciliation | ALR-010-R2/R2e, ALR-020..080 | G0/TASK_GRAPH/QA gates/G1_REVIEW | Factory DB event/gate evidence for `173433`/`173494`, event 174440 ALR-020 metadata read-back, Git ancestry proof, Zeus-signed `agent:zeus` PR, and PR/QA evidence where required | ALR-061/062 plus R2e exact-SHA independent review | ALR-080 |
