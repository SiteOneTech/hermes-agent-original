...
- Repair: R2c2 updates only project-local documentation/index/review handoff artifacts to reconcile the current canonical document-status evidence and records a fresh PR-first independent-review handoff. It does not change product/runtime code, merge, deploy, change credentials, write direct SQL, or authorize external/runtime/trading behavior.
