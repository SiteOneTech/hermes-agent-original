...
### R2m/R2n/R2o/R2p/R2q/R2r G1 documentation reconciliation chain
...
- R2r recovers R2q source commit `11639ab1650a4d7abfa88820bc266c983a56d1fd` as a PR-first replacement on branch `factory/zeus-alpha-research-ledger-core/inc-001-r2r-pr-first-recovery-of-the-r2q`, because the source R2q commit had no open PR, no Zeus author and no Zeus sign-off.
- Incorporated repairs: `R2J_CANONICAL_STATE_REPAIR.md`, `R2K_STALE_CANONICAL_G1_PROVENANCE_REPAIR.md`, `R2M_CURRENT_BASE_G1_REVIEW_HANDOFF.md`, `R2Q_CURRENT_MAIN_G1_REVIEW_CANDIDATE_RECOVERY.md` and `R2R_PR_FIRST_RECOVERY_OF_R2Q_G1_REVIEWED_DOCS_CANDIDATE.md` remain indexed controlling artifacts, but PR #20/dad375f, PR #29/f61a, R2i `already_ancestor`, PR #30/c1943, PR #31/73b, R2m exposure, PR #35/R2p, provider-failed review runs and the unsigned/no-PR R2q source commit are historical or invalid and cannot dispatch ALR-020.
- Boundary: R2r performs no product implementation, merge, deploy, credential change, direct SQL or external-runtime execution. Primary readiness is not claimed until Agent Core `document_status` or an authorized reviewed-candidate metadata path reads back zero required G1 blockers and exact-SHA solution-architect review evidence is valid against the final open PR head.
...
| `zeus-alpha-research-ledger-core-r2r-pr-first-recovery-of-the-r2q-g1-revi` | documentation / claimed | claude-builder → solution-architect | unsigned/no-PR R2q source commit `11639ab1650a4d7abfa88820bc266c983a56d1fd`; PR-first replacement required | `factory/zeus-alpha-research-ledger-core/inc-001-r2r-pr-first-recovery-of-the-r2q` | `/home/jean/Projects/.worktrees/zeus-alpha-research-ledger-core/inc-001-r2r-pr-first-recovery-of-the-r2q` |
...
- R2q/R2r adds an explicit guard for candidate-versus-primary readiness and provider-failure/provenance integrity: branch-local `reviewed: yes` markers are backed by gate 790, but primary readiness is not true until canonical Factory read-back or authorized reviewed-candidate metadata reads zero G1 blockers and an independent `solution-architect` review cites the final R2r open-PR head SHA with executed-review evidence.
