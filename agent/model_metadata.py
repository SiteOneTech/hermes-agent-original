...
def _model_name_suggests_minimax_m3(model: str) -> bool:
    ...
    similar variants across surfaces. Used by the models.dev underreport guard
    and stale pre-catalog cache handling: older builds could persist the
    generic ``minimax`` catch-all (204,800) before the ``minimax-m3`` 1M
