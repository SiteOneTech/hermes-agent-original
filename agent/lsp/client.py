...
class LSPClient:
    ...
    async def remove_workspace_folder(self, root: str) -> None:
        """Detach an idle secondary root from a multi-root server.  The initialization root stays
        attached for the client's lifetime; it anchors servers that expect ``rootUri`` to stay valid."""
