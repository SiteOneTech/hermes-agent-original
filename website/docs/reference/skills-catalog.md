...
| Skill | Description | Path |
|-------|-------------|------|
| [`factory-sandbox-kidu`](../user-guide/skills/bundled/devops/devops-factory-sandbox-kidu.md) | Check, restart, or deploy previews to the Kidu sandbox VM. | `devops/factory-sandbox-kidu` |
| [`kanban-orchestrator`](../user-guide/skills/bundled/devops/devops-kanban-orchestrator.md) | Decomposition playbook for the Kanban orchestrator role. | `devops/kanban-orchestrator` |
| [`kanban-worker`](../user-guide/skills/bundled/devops/devops-kanban-worker.md) | Pitfalls and edge cases for Hermes Kanban workers. | `devops/kanban-worker` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`agent-crm-core`](../user-guide/skills/bundled/productivity/productivity-agent-crm-core.md) | Operate Agent CRM Core: contacts, deals, quotes, invoices. | `productivity/agent-crm-core` |
...
| [`twenty-crm-adapter`](../user-guide/skills/bundled/productivity/productivity-twenty-crm-adapter.md) | Use Twenty CRM as the external adapter for Agent CRM Core. | `productivity/twenty-crm-adapter` |
...
| [`factory-agent-operating-canon`](../user-guide/skills/bundled/software-development/software-development-factory-agent-operating-canon.md) | Use when acting as any SitioUno Software Factory agent role. | `software-development/factory-agent-operating-canon` |
