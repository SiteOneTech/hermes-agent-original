---
title: "Video Intel Pipeline — Descarga y transcribe videos con yt-dlp y faster-whisper"
sidebar_label: "Video Intel Pipeline"
...
Descarga y transcribe videos con yt-dlp y faster-whisper.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/media/video-intel-pipeline` |
| Path | `optional-skills/media/video-intel-pipeline` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
...
| Related skills | [`youtube-content`](../../bundled/media/media-youtube-content.md) |
