---
title: "Twenty Crm Adapter — Use Twenty CRM as the external adapter for Agent CRM Core"
sidebar_label: "Twenty Crm Adapter"
...
Use Twenty CRM as the external adapter for Agent CRM Core.
...
| Path | `skills/productivity/twenty-crm-adapter` |
| Version | `1.0.0` |
