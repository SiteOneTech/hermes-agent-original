...
class ProfileInfo:
    ...
    description: str = ""
    # Optional dashboard-facing display label. This is separate from ``name``:
    # ``name`` remains the stable on-disk/profile id.
    display_name: str = ""
    # Optional dashboard-facing avatar web path, normally /agent-avatars/<asset>.webp.
    avatar_path: str = ""
