...
from hermes_cli.web_routers import factory as _factory_routes  # noqa: E402
# Legacy re-export: ``web_server.<name>`` stays the address for the factory helpers/handlers.
from hermes_cli.web_routers.factory import (  # noqa: E402,F401
    _factory_append_notion_page_children, _factory_counts, _factory_dashboard_slice,
    _factory_doc_external_url, _factory_doc_inventory, _factory_effective_gates,
    _factory_gate_created_at, _factory_handoff_prompt, _factory_json_load, _factory_markdown_cell,
    _factory_markdown_link, _factory_notion_blocks, _factory_notion_markdown,
    _factory_notion_page_url, _factory_notion_parent_page_id, _factory_notion_rich_text,
    _factory_notion_template, _factory_project_artifact_dir, _factory_project_dashboard,
    _factory_project_metadata, _factory_project_notion, _factory_replace_notion_page_children,
    _factory_repo_web_base, _factory_repository_strategy_card, _factory_sort_gates_desc,
    _factory_update_project_metadata, _factory_utc_now, _notion_api_key, _notion_page_title,
    _notion_request, create_factory_project_notion, get_factory_agents, get_factory_artifacts,
    get_factory_dashboard, get_factory_events, get_factory_findings, get_factory_gates,
    get_factory_kanban_boards, get_factory_project_handoff, get_factory_projects,
    get_factory_tasks, run_factory_project_action, sync_factory_project_notion)
...
app.include_router(_factory_routes.router)

# Public-token workspace surfaces (customer/coach), not dashboard session routes; mounted with
# the API routers so the SPA catch-all cannot swallow them.
