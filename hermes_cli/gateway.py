...
def get_python_path() -> str:
    ...
    if venv is not None:
        try:
            ...
            # without this symbol. Reload it directly rather than via
            # _reload_hermes_constants() in hermes_cli/managed_uv.py — managed_uv can be cached
            # from that same old checkout, so importing the recovery helper would fail too.
            import importlib
