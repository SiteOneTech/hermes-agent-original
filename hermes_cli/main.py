...
def _forward_command(name: str, module: str, attr: str, *, forward_return: bool = False, doc: str = ""):
    ...
    surfaces the return code to ``main()`` (cron/kanban/factory/project/mcp propagate).
    """
...
cmd_factory = _forward_command("cmd_factory", "hermes_cli.factory", "factory_command", forward_return=True, doc='SitioUno Software Factory orchestration state.')
...
_BUILTIN_SUBCOMMANDS = frozenset(
    {
        ...
        "dump", "egress", "factory", "fallback", "gateway", "hooks", "import", "import-agent", "insights",
...
def _build_cli_parser():
    ...
    _build_factory_parser(subparsers).set_defaults(func=cmd_factory)
